...
MAIN.BackgroundColor3 = Color3.new(0.01568627450980392, 0.01568627450980392, 0.01568627450980392)
...
TITLE.Text = "Infinite no key"
TITLE.TextColor3 = Color3.fromRGB(227, 77, 209)
TITLE.TextScaled = true
TITLE.TextSize = 14.000
TITLE.TextWrapped = true

LOADING.Name = "LOADING Infinite Hub"
LOADING.Parent = MAIN
...
wait(1)
LOADING.Text = "LOADING Infinite Hub"
BAR:TweenSize(UDim2.new(0, 150,0, 15), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, .3, true)
wait(1)
LOADING.Text = "Infinite Hub xin chào " ..game.Players.LocalPlayer.DisplayName.. " From: ".. code
...
wait(1)
LOADING.Text = "Script Infinite no key"
...
local Window = Fluent:CreateWindow({
    Title = "Infinite Hub [update2,3]",
    SubTitle = "Kiếm tiền vì đam mê",
    TabWidth = 160,
